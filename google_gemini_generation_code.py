# -*- coding: utf-8 -*-
"""Google Gemini Generation Code

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1x5uzND-hKdzj_suOJk5lM5wa_Amwt-RG
...
# API key for Google Gemini - store this in Google Colab secrets as 'GEMINI_API_KEY'
...
*   model, parameter, and backoff function (to avoid getting rate limit with the Gemini API)
"""

def generate_definition(word, model_name="gemini-2.0-flash-001", max_retries=5):
...
"""
    ...
    prompt = kbbi_style_guidelines.format(word=word)
    ...
    for attempt in range(max_retries):
        try:
            ...
            if response.candidates and response.candidates[0].content.parts:
                ...
                print(f"Empty or blocked response for '{word}' (attempt {attempt+1}/{max_retries})")
            ...
            if "quota" in str(e).lower() or "rate" in str(e).lower():
                ...
                print(f"Rate/quota limited. Waiting {wait_time} seconds...")
                time.sleep(wait_time)
            else:
                time.sleep(5)  # General backoff
